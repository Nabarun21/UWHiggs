...
class LFVHEMuAnalyzerMVABDTmet27QCD(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDTmet27QCD, self).__init__(tree, outfile, **kwargs)
...
#        pudir =['','fakeRateMethod/'] uncoment if using old fr method
        ...
        alllooselist=['antiIsolated/']#,'antiIsolatedweighted/']
...
#                    histos[folder+'/mPFMETDeltaPhi_vs_ePFMETDeltaPhi'].Fill(abs(row.mDPhiToPfMet_type1),abs(row.eDPhiToPfMet_type1) , antiIsolatedWeight)
        ...
        if region!='signal':
            ...
            antiIsolatedWeightList=[1,fakerateWeight]
...
#                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Phi()
#                        print " "
                        self.my_elec.SetPtEtaPhiM(row.ePt*self.generator.Gaus(1,0.02546),row.eEta,row.ePhi,row.eMass)
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
...
#                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Phi()
#                        print " "
                        self.my_elec.SetPtEtaPhiM(row.ePt*self.generator.Gaus(1,0.01254),row.eEta,row.ePhi,row.eMass)
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
                        self.my_MET.SetPxPyPzE(self.my_METpx,self.my_METpy,0,sqrt(self.my_METpx*self.my_METpx+self.my_METpy*self.my_METpy))
...
#                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Phi()
#                        print " "
                        self.my_elec.SetPtEtaPhiM(row.ePt*self.generator.Gaus(1,0.02554),row.eEta,row.ePhi,row.eMass)
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
...
#                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Phi()
#                        print " "
                        self.my_elec.SetPtEtaPhiM(row.ePt*self.generator.Gaus(1,0.01250),row.eEta,row.ePhi,row.eMass)
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
                        self.my_MET.SetPxPyPzE(self.my_METpx,self.my_METpy,0,sqrt(self.my_METpx*self.my_METpx+self.my_METpy*self.my_METpy))
...
#                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Phi()
#                        print " "
                        self.my_elec.SetPtEtaPhiM(row.ePt*self.generator.Gaus(1,0.02550),row.eEta,row.ePhi,row.eMass)
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
                        self.my_MET.SetPxPyPzE(self.my_METpx,self.my_METpy,0,sqrt(self.my_METpx*self.my_METpx+self.my_METpy*self.my_METpy))
...
#                        self.my_METpx=self.my_MET.Px()+self.my_elec.Px()
                        self.my_METpy=self.my_MET.Py()+self.my_elec.Py()
                        self.my_elec.SetPtEtaPhiM(row.ePt*self.generator.Gaus(1,0.01250*(float(6.6)/float(sqrt(row.ePt)))),row.eEta,row.ePhi,row.eMass)
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
                        self.my_MET.SetPxPyPzE(self.my_METpx,self.my_METpy,0,sqrt(self.my_METpx*self.my_METpx+self.my_METpy*self.my_METpy))
                        self.shifted_mDPhiToPfMet=deltaPhi(self.my_MET.Phi(),self.my_muon.Phi())
                        ...
                        self.my_METpx=self.my_MET.Px()+self.my_elec.Px()
                        self.my_METpy=self.my_MET.Py()+self.my_elec.Py()
                        self.my_elec.SetPtEtaPhiM(row.ePt*self.generator.Gaus(1,0.02550*(float(6.6)/float(sqrt(row.ePt)))),row.eEta,row.ePhi,row.eMass)
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
                        self.my_MET.SetPxPyPzE(self.my_METpx,self.my_METpy,0,sqrt(self.my_METpx*self.my_METpx+self.my_METpy*self.my_METpy))
