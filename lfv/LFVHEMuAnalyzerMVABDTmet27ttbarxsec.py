...
class LFVHEMuAnalyzerMVABDTmet27ttbarxsec(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDTmet27ttbarxsec, self).__init__(tree, outfile, **kwargs)
 ...
 #        self.DYlowmass_weight=1.99619334706e-08
        ...
        self.mym1='m'
        self.mye1='e'
        self.topptreweight_sum=0
        self.count=0

        if self.syscalc and not self.isData:
#            self.sysdir=['nosys','mesup']
            self.sysdir=['nosys','uup','udown','mesup','mesdown','eesup','eesdown','eresup','eresdown','eEtdependent','enomsmear']
...
#        print eisocorr
        ...
        if self.isTT:
            ...
            self.topptreweight_sum+=topptreweight
            self.count+=1
...
#                print sys,"     ",MVAval
        ...
        cut_flow_trk.flush()        
        try:
            print self.topptreweight_sum,"   ",self.count                
        except ZeroDivisionError:
            pass

    def finish(self):
        try:
            print 'FINISH ',self.topptreweight_sum,"   ",self.count                
        except ZeroDivisionError:
            pass
        self.write_histos()
