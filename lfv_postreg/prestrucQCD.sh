...
python getQCD.py $analyzer $luminosity $jobid $analtype $sys 'QCDCR' 
#python getQCDforcombine.py $analyzer $luminosity $jobid $analtype $sys 'QCDCR'  #get the same without sysuncertainty in histos, combine script already adds them
...
python prepHistos.py $analyzer $luminosity $jobid $analtype 'QCDCR'
