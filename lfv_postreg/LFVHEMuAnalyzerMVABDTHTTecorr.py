...
import FinalStateAnalysis.TagAndProbe.HtautauCorrection as HtautauCorrection
...
eiso_corr0p10 =HtautauCorrection.idiso0p10_ele_2016_final



class LFVHEMuAnalyzerMVABDTHTTecorr(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDTHTTecorr, self).__init__(tree, outfile, **kwargs)
...
#        eidcorr = eId_corrector(electron_Eta,electron_Pt)
        ...
        eidcorr=eiso_corr0p10(electron_Pt,abs(muon_Eta))[0]
