...
class LFVHEMuAnalyzerMVABDTv1(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDTv1, self).__init__(tree, outfile, **kwargs)
...
#            self.sysdir=['nosys','mesup']
            self.sysdir=['nosys','uup','udown','checkuup','checkudown','mesup','mesdown','eesup','eesdown','eresup','eresdown','eEtdependent','enomsmear']
...
#                self.book(f, "jetN_20", "Number of jets, p_{T}>20", 10, -0.5, 9.5) 
        ...
        for s in sign:
            ...
            self.book(s, "eMtToPfMet",  "eMtToPfMet",  300, 0, 300) 
            self.book(s, "mMtToPfMet",  "mMtToPfMet",  300, 0, 300) 
            self.book(s, "dPhiMetToE",  "dPhiMetToE",  50, 0, 3.2)
            self.book(s, "h_vismass",  "h_vismass",  300, 0, 300) 
