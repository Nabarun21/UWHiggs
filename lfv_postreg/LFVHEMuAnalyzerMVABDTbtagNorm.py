...
class LFVHEMuAnalyzerMVABDTbtagNorm(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDTbtagNorm, self).__init__(tree, outfile, **kwargs)
...
#            self.sysdir=['nosys','mesup']
            ...
            self.sysdir=['nosys','btagup','btagdown']
            self.jetsysdir=[]
#        self.sysdir=['nosys']
        if self.is_WJet:
...
#            print "non-repeat"
            ...
            for sys in self.sysdir:
                ...
                if sys =='btagup':
                    ...
                    if nbtagged>0:
                        if nbtagged==1:
                            btagweight=bTagSF.bTagEventWeight(nbtagged,row.jb1pt,row.jb1hadronflavor,row.jb2pt,row.jb2hadronflavor,1,1,0) if (row.jb1pt>-990 and row.jb1hadronflavor>-990) else 0
                        if nbtagged==2:
                            btagweight=bTagSF.bTagEventWeight(nbtagged,row.jb1pt,row.jb1hadronflavor,row.jb2pt,row.jb2hadronflavor,1,1,0) if (row.jb1pt>-990 and row.jb1hadronflavor>-990 and row.jb2pt>-990 and row.jb2hadronflavor>-990) else 0
