...
class LFVHEMuAnalyzerMVABDTcheck(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDTcheck, self).__init__(tree, outfile, **kwargs)
...
#                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Phi()
#                        print " "
                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Pz(),"   ",self.my_elec.E()

                        my_rand_num=self.generator.Gaus(1,0.01254)
                        print my_rand_num
                        self.my_elec*=my_rand_num
                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Pz(),"   ",self.my_elec.E()
                        self.my_elec.SetPtEtaPhiM(row.ePt,row.eEta,row.ePhi,row.eMass)
                        self.my_elec.SetPxPyPzE(self.my_elec.Px()*my_rand_num,self.my_elec.Py()*my_rand_num,self.my_elec.Pz()*my_rand_num,self.my_elec.E()*my_rand_num)
                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Pz(),"   ",self.my_elec.E()

                        self.my_elec.SetPtEtaPhiM(row.ePt*my_rand_num,row.eEta,row.ePhi,row.eMass)
                        print "elec   ",self.my_elec.Px(),"   ",self.my_elec.Py(),"   ",self.my_elec.Pz(),"   ",self.my_elec.E()
                        print ""
                        self.my_METpx-=self.my_elec.Px()
                        self.my_METpy-=self.my_elec.Py()
