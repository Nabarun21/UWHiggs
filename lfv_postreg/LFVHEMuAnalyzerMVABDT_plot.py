...
class LFVHEMuAnalyzerMVABDT_plot(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):

        self.channel='EMu'
        super(LFVHEMuAnalyzerMVABDT_plot, self).__init__(tree, outfile, **kwargs)
 ...
 #                   for k in threshold:
        ...
        for k in range(len(folder)):
            ...
            if 'selected' not in f:
                ...
                self.book(f, "em_DeltaR", "e-mu DeltaR" , 60, 0, 6)
#            
...
#                self.book(f, "jetN_20", "Number of jets, p_{T}>20", 10, -0.5, 9.5) 
        ...
        for s in sign:
            ...
            self.book(s, "em_DeltaR", "e-mu DeltaR" , 120, 0, 6)
...
#            if btagweight<0:btagweight=0
            ...
            for sys in self.sysdir:
                ...
                self.emDphi=deltaPhi(self.my_muon.Phi(),self.my_elec.Phi())
